...
// "Waves > Sea Surf. Temp > Coral Reef Watch > Actual" is the four taps a person makes
...
function mapCommand() {
  return new SlashCommandBuilder()
    ...
    .addStringOption(o => o.setName('layer')
      .setDescription(`Like the site's menu: Waves > Sea Surf. Temp > Coral Reef Watch > Actual. Join more with ${MULTI_SEP}`)
...
// Matching ignores case and spacing, so "waves>period" still finds its path.
...
// "Waves > Sea Surf. Temp > Coral Reef Watch > Actual". What comes before the last |
