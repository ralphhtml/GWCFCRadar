...
console.log('\n6b. the Radar 3D toolkit, and the look');
{
  ...
  // Frosted glass: its own tint, or the shared panel shell's (the weather
  // station popup's look every panel wears now).
  ok('and the panel below is frosted glass',
     /rgba\(24, 28, 34, 0\.58\)|rgba\(22, 26, 32, 0\.6\)/.test(r.panelBg), r.panelBg);
}
